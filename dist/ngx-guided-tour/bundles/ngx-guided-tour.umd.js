(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/operators'), require('lodash/cloneDeep'), require('rxjs'), require('@angular/core'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define('ngx-guided-tour', ['exports', 'rxjs/operators', 'lodash/cloneDeep', 'rxjs', '@angular/core', '@angular/common'], factory) :
    (factory((global['ngx-guided-tour'] = {}),global.rxjs.operators,global.cloneDeep,global.rxjs,global.ng.core,global.ng.common));
}(this, (function (exports,operators,cloneDeep,rxjs,core,common) { 'use strict';
    ...
    var WindowRefService = /** @class */ (function () {
        ...
        /** @nocollapse */
        WindowRefService.ctorParameters = function () {
            return [
    ...
    var GuidedTourService = /** @class */ (function () {
        function GuidedTourService(errorHandler, windowRef, dom) {
            ...
            rxjs.fromEvent(this.windowRef.nativeWindow, 'resize').pipe(operators.debounceTime(200)).subscribe(( /**
             * @return {?}
             */function () {
    ...
    var GuidedTourComponent = /** @class */ (function () {
         ...
         */
            function () {
                ...
                this.resizeSubscription = rxjs.fromEvent(this.windowRef.nativeWindow, 'resize').subscribe(( /**
                 * @return {?}
                 */function () {
                    _this.updateStepLocation();
                }));
                this.scrollSubscription = rxjs.fromEvent(this.windowRef.nativeWindow, 'scroll').subscribe(( /**
                 * @return {?}
                 */function () {
                    _this.updateStepLocation();
                }));
        ...
        GuidedTourComponent.propDecorators = {
            ...
            skipText: [{ type: core.Input }],
            nextText: [{ type: core.Input }],
            doneText: [{ type: core.Input }],
            closeText: [{ type: core.Input }],
            backText: [{ type: core.Input }],
            progressIndicatorLocation: [{ type: core.Input }],
            progressIndicator: [{ type: core.Input }],
            tourStep: [{ type: core.ViewChild, args: ['tourStep', { static: false },] }]
        };
         ...
         */
            function () {
                return {
                    ...
                    providers: [core.ErrorHandler, GuidedTourService],
                };
            };
    ...
    exports.ProgressIndicatorLocation = ProgressIndicatorLocation;
